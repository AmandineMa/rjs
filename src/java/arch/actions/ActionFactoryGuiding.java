...
import arch.actions.ros.disambi.StartROSNodeDisambi;
...
public class ActionFactoryGuiding extends AbstractActionFactory {
	
	private static Publisher<std_msgs.String> lookAtEventsPub; 
	private static Publisher<std_msgs.String> humanToMonitorPub; 
	
	public ActionFactoryGuiding(AbstractROSAgArch rosAgArch) {
		super(rosAgArch);
	...
	public static Action createAction(ActionExec actionExec, AbstractROSAgArch rosAgArch) {
		...
		switch(actionName) {
			...
			case "startROSNodeGuiding":
				...
				break;
			case "startROSNodeDisambi":
				action = new StartROSNodeDisambi(actionExec, rosAgArch);
				break;
			case "initServices":
